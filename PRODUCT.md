...
Web — a statically generated Astro site hosted on GitHub Pages.
...
- Static output with no search service or application backend.
- Fast, accessible client-side filtering is appropriate for the Ideas archive.
...
- Dastan Aitzhanov writes in a first-person, systems-oriented, conversational, and thoughtful voice.
- The visual character is a quiet editorial notebook with strong typography and generous space.
- The site should feel considered and alive without behaving like a campaign or a content-marketing machine.
- Existing writing and project content remains authoritative unless a task explicitly changes it.
...
1. Make relationships among ideas legible.
2. Let readers browse deeply without making the site feel like a dashboard.
3. Reveal uncertainty and provenance honestly.
4. Keep taxonomy small enough to remain meaningful.
5. Favor durable, fast, accessible static behavior.

## Accessibility & Inclusion

Search and filtering must be keyboard-operable, use semantic controls, retain visible focus, meet contrast expectations, and work comfortably on narrow and wide screens.
