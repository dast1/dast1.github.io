...
Letting a generative model talk its way into an exception means the exception is different every time, and nobody can diff it. Low confidence is a branch you wrote, to a stronger model, a person, or a stop. It is not a softer yes hidden in the prose.
